...
**Unit-impulse view (Eq. 3.19; used by `carspan`).** Following Rompelman (1985) and Mulder [(1988)](#ref-mulder1988), the heartbeat is modelled as a sequence of unit impulses at the R-peak times $t_i$:
