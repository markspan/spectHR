...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionAdd_Epoch = QAction(MainWindow)
        self.actionAdd_Epoch.setObjectName(u"actionAdd_Epoch")
        self.actionFlip_Ecg = QAction(MainWindow)
        self.actionFlip_Ecg.setObjectName(u"actionFlip_Ecg")
        self.actionEdit_Workspace = QAction(MainWindow)
        self.actionEdit_Workspace.setObjectName(u"actionEdit_Workspace")
...
"")
        ...
        self.menuEdits = QMenu(self.menubar)
        self.menuEdits.setObjectName(u"menuEdits")
        ...
        self.menufile.addAction(self.actionEdit_Workspace)
